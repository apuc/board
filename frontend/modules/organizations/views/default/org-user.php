    ...
    <div class="container">
        <ul class="kabinet-header__mnu">
            <li><a href="<?= Url::to([
                    ...
                    'login' => \common\classes\UserFunction::getUserLoginById($user_id),
                ]) ?>"><span class="shops-ad"></span>Объявления пользователя</a></li>
            ...
            <li><a href="<?= \yii\helpers\Url::to([
                    ...
                    'username' => \common\classes\UserFunction::getUserLoginById($user_id),
                ]) ?>" target="_blank"><span class="kabinet-header-icon-mail "></span>Связаться с автором</a></li>
        </ul>
    </div>
</section>
            ...
            if (empty($org)) { ?>
                <div class="ad-author__content_left-item">
                    <div class="kabinet-active-ad__content_ad">
                        <div class="warning-pic"><img src="/img/warning-icon.png" alt=""></div>
                        <span class="warning-row">
                          У пользователя пока нет компаний
                        </span>
                    </div>
                </div>
            <?php }
            ...
            <?php foreach ($org as $model): ?>
                <div class="ad-author__content_left-item">
                    <div class="average-ad-item">
                        <a href="<?= Url::to(['/organizations/default/view', 'slug' => $model['slug']]) ?>"
                        ...
                        <div class="average-ad-item-content">
                            ...
                            <div class="bottom-content">
                                ...
                                <div class="right">
                                    ...
                                    ]) ?>" class="average-ad-category"><?= $model['category_name'] ?></a>
                                    <a href="<?= Url::to([
                                        '/organizations/default/all',
                                        'slug' => $model['category_parent_slug'],
                                    ]) ?>" class="average-ad-category"><?= $model['category_parent_name'] ?></a>
