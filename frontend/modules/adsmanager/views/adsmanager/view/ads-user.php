...
<section class="ad-author__menu">
    <div class="container">
        <ul class="kabinet-header__mnu">
            ...
            <li><a href="<?= \yii\helpers\Url::to(['/organizations/default/user_org', 'login' => $user])?>"><span class="shops-my"></span>Организации пользователя</a></li>
            <li><a href="<?= \yii\helpers\Url::to(['/message/default/dialog', 'username' => $user ])?>" target="_blank"><span class="kabinet-header-icon-mail "></span>Связаться с автором</a></li>
        </ul>
    </div>
</section>
