...
if($adsFields[0]['ads_fields_type']->type == 'text'){?>
    <div class="form-line field-ads-<?= $adsFields[0]->name; ?>">
        <div class="form-line">
            ...
            <?= \yii\helpers\Html::textInput('AdsField[' . $adsFields[0]->name . ']', $adsFieldValue[$adsFields[0]->name]->value, ['class' => 'input-name jsHint']) ?>
...
if($adsFields[0]['ads_fields_type']->type == 'select'){
    ...
    <div class="form-line field-ads-<?= $adsFields[0]->name; ?>">
        <div class="form-line">
            ...
            <?= \yii\helpers\Html::dropDownList('AdsField[' . $adsFields[0]->name . ']', $adsFieldValue[$adsFields[0]->name]->value_id, $arr, ['class' => 'input-name jsHint',  'prompt' => 'Выберите']) ?>
            <div class="error"><div class="help-block"></div></div>
            <div class="memo"><span class="info-icon"></span><span class="triangle-left"></span><?= $adsFields[0]->hint; ?></div>
        </div>
    </div>
