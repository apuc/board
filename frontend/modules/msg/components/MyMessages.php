...
use frontend\modules\msg\events\MessageEvent;
use frontend\modules\msg\exceptions\ExceptionMessages;
...
class MyMessages extends Component {
    ...
    protected function getMessages($whom_id, $from_id = null, $type = null, $last_id = null) {
        ...
        $query
            ...
            /*->leftJoin("profile", "`profile`.`user_id` = ``")*/
        ...
        return array_map(function ($r) use ($user_id) {
            ...
            $r['ava'] = UserFunction::getUser_avatar_url($r['from_id'],true);
            return $r;
        }, $return);
    }
