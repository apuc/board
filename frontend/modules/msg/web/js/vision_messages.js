...
var visiPrivateMessages = (function() {
    ...
    return function(id_block_) {
        ...
        this.createHtmlMessage = function(n) {
            var html = '';
            //html += (n['i_am_sender'] ? '<div class="msg_ava msg_ava_right"></div>' : '<div class="msg_ava msg_ava_left"></div>');
            ...
            //html += '<p>' + n['message'] + '</p>';
            //html += '</div>';
            html += '<div class="conversation__' + (n['i_am_sender'] ? 'right' : 'left') + '">';
            html += '<span class="conversation__' + (n['i_am_sender'] ? 'right' : 'left') + '--message">' + n['message'] + '</span>';
            html += '<span class="conversation__' + (n['i_am_sender'] ? 'right' : 'left') + '--avatar"><img src="' + n['ava'] + '" alt=""></span>';
            html += '</div>';
            return html;
        };
