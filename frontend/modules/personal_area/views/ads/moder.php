...
$this->params['breadcrumbs'][] = ['label' => 'На модерации'];
        ...
        <div class="kabinet-active-ad__right">
            ...
            <div class="kabinet-active-ad__additionaly-option">
                <ul>
                    ...
                    <li class="option active"><a href="<?= Url::toRoute(['/personal_area/ads/ads_user_moder'])?>">На проверке </a></li>
                </ul>
                <!--<a href="" class="option-2">Опубликовать</a>-->
                <!--<a href="" class="option-2"><span class="up-option"></span>Активировать на 60 дней и поднять</a>-->
               <!-- <a href="" class="option-2">Активировать</a>
                <div class="checkbox0">
            ...
            <?php if(empty($ads)): ?>
                <?= $this->render('/error/error',['title' => 'У Вас нет объявлений на модерации', 'link_title' => 'Добавить объявление', 'url' => Url::toRoute(['/adsmanager/adsmanager/create'])]); ?>
            <?php else: ?>
                ...
                <?php foreach ($ads as $item):
                    ...
                    <div class="item">
                        ...
                        <div class="checkbox">
                            <input id="check<?/*=$item->id; */?>" type="checkbox" data-id="<?/*=$item->id; */?>" name="check" value="<?/*=$item->id; */?>">
