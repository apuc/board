    ...
    <div class="container">
        ...
        <div class="kabinet-active-ad__right">
            ...
            <div class="kabinet-active-ad__additionaly-option">
                <ul>
                    <li class="option" ><a href="<?= Url::toRoute(['/personal_area/ads/ads_user_active'])?>">Активные</a></li>
                    <li class="option active"><a href="<?= Url::toRoute(['/personal_area/ads/ads_user_not_active'])?>">Неактивные</a></li>
                ...
                <?php if(!empty($ads)):?>
                    <a href="" class="option-2 delete-all" data-csrf="<?= Yii::$app->request->getCsrfToken()?>" data-ads="not-active" data-page="<?= $request->get('page', 1); ?>">Удалить</a>
                    <a href="" class="option-2 publication-all" data-csrf="<?= Yii::$app->request->getCsrfToken()?>" data-page="<?= $request->get('page', 1); ?>">Активировать</a>
                    <div class="checkbox0">
            ...
            <?php if(empty($ads)): ?>
                <?= $this->render('/error/error',['title' => 'У Вас нет неактивных объявлений', 'link_title' => 'Добавить объявление', 'url' => Url::toRoute(['/adsmanager/adsmanager/create'])]); ?>
            <?php else: ?>
                    ...
                    <div class="item">
                        ...
                        <div class="item-edit-ad">
                            ...
                            <?php if($item->status == 5): ?>
                                ...
                                <a href="" class="publish-ad publication" data-csrf="<?= Yii::$app->request->getCsrfToken()?>" data-id="<?=$item->id;?>" data-page="<?= $request->get('page', 1); ?>">
