...
$this->title = 'Мои организации | Активные';
...
<section class="kabinet-active-ad">
    <div class="container">
        <div class="kabinet-active-ad__left">
            <ul>
                <li><a href="">Управление организациями</a></li>
        ...
        <div class="kabinet-active-ad__right">
            ...
            <div class="kabinet-active-ad__additionaly-option">
                <ul>
                    ...
                    <!--<li><a href="<?/*= Url::toRoute(['/personal_area/org/org_user_not_active']); */?>">Неактивные</a></li>-->
                    <li><a href="<?= Url::toRoute(['/personal_area/org/org_user_moder']); ?>">На проверке </a></li>
                </ul>
                <?php if(!empty($org)):?>
            ...
            <?php if(empty($org)): ?>
                <?= $this->render('/error/error',['title' => 'У Вас нет неактивных организаций', 'link_title' => 'Добавить организацию', 'url' => Url::toRoute(['/organizations/default/add'])]); ?>
            <?php else: ?>
