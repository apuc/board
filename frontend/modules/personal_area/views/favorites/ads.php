                    ...
                    <div class="average-ad-item <?=(in_array($item['ads']->status, [3,5])) ? 'average-ad-item-hide' : ''; ?>">
                        ...
                        <div class="average-ad-item-content">
                            ...
                            <p class="average-ad-geo">
                                ...
                                <a class="addressAds" href="<?= \yii\helpers\Url::to(['/adsmanager/filter/filter_search_view', 'regionFilter' => $item['ads']['geobase_region'][0]->id])?>"><?= $item['ads']['geobase_region'][0]->name; ?></a> |
                                <a class="addressAds" href="<?= \yii\helpers\Url::to(['/adsmanager/filter/filter_search_view', 'cityFilter' => $item['ads']['geobase_city']->id])?>"><?= $item['ads']['geobase_city']->name; ?></a>
                            </p>
                            <span class="average-ad-price"><?= number_format($item['ads']->price, 0, '.', ' '); ?>
