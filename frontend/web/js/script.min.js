...
// open all-shops-category menu
 ...
 $(document).ready(function() {
  ...
  // if ($('.ad-charasteristics, .news__right').length > 0) {
  //   var formTop = $('.ad-charasteristics, .news__right').offset().top;
  //   $(window).scroll(function(){
  //
  //    var windowTop = $(window).scrollTop();
  //    var formWidth = $('.ad-charasteristics, .news__right').width();
  //    var fluidVal = ( formWidth/$(window).width() ) * 100;
  //
  //
  //    if (formTop < windowTop  ) {
  //      $('.ad-charasteristics-form, .other-news').css({
  //        position: 'fixed',
  //        top: 10,
  //       //  bottom: 200,
  //        width: fluidVal + "%",
  ...
  //  });
  // }
  // var offset = $(".other-news").offset();
  // var topPadding = 15;
  // $(window).scroll(function() {
  //   if ($(window).scrollTop() > offset.top) {
  //     $(".other-news").stop().animate({marginTop: $(window).scrollTop() - offset.top + topPadding});
  //   }
  //   else {$(".other-news").stop().animate({marginTop: 0});};});
  ...
  $(window).scroll(function() {
    ...
    var sb = $(".news__right, .ad-charasteristics");
    var sbi = $(".other-news, .ad-charasteristics-form");
    ...
    var sb_m_n = 0; /* отступ сверху и снизу */
    var mb_n = 300; /* высота подвала с запасом */
