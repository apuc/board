                    ...
                    <div class="mdc-list-item mdc-drawer-item" href="#" data-toggle="expansionPanel" target-panel="ui-sub-menu">
                        ...
                        <div class="mdc-expansion-panel" id="ui-sub-menu">
                            <nav class="mdc-list mdc-drawer-submenu">
                                <div class="mdc-list-item mdc-drawer-item">
                                    <a class="mdc-drawer-link" href="<?= \yii\helpers\Url::to(['/personal_area/ads/ads_user_active']) ?>">
                                        Активные
                                    </a>
                                </div>
                                <div class="mdc-list-item mdc-drawer-item">
                                    <a class="mdc-drawer-link" href="<?= \yii\helpers\Url::toRoute(['/personal_area/ads/ads_user_not_active'])?>">
                                        Неактивные
                                    </a>
                                </div>
                                <div class="mdc-list-item mdc-drawer-item">
                                    <a class="mdc-drawer-link" href="<?= \yii\helpers\Url::toRoute(['/personal_area/ads/ads_user_moder'])?>">
                                        На проверке
                                    </a>
                                </div>
                            </nav>
