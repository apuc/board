...
<table width="900px" align="center" cellpadding="0" cellspacing="0" border="0" data-mobile="true" dir="ltr"  style="width:auto; font-size: 16px; background: url(https://rub-on.ru/frontend/web/img/mail/mail_bg.png) 50% 0% no-repeat rgb(196, 196, 196);">
    <thead>
    <tr>
        <td align="center">
                                                        ...
                                                        <td valign="top" align="left" style="padding: 15px 30px 0px 30px; margin: 0px; font-family: Arial, Helvetica, sans-serif; color: rgb(38, 38, 38); line-height: 2.05; background-color: rgba(13, 14, 22, 0.8);">
                                                            <table border="0" cellpadding="0" cellspacing="0" align="left" data-editable="image" style="text-align: right; margin: 0px; padding: 0px;" data-mobile-width="1" id="edi7i0nm" width="154">
                                                                ...
                                                                <tr style="text-align: right;">
                                                                    <td valign="top" align="left" style="display: inline-block; padding: 0px 10px 10px 0px; margin: 0px;" class="tdBlock"><img src="https://rub-on.ru/frontend/web/img/mail/mail_logo.png" width="148"  height="39" style="border: 0px none transparent; display: block;"></td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" align="center" width="600" data-editable="line">
                            ...
                            <tr>
                                <td valign="top" align="center" style="padding: 10px 0px; margin: 0px; background-color: rgba(13, 14, 22, 0.8);">
                                    <div style="">
                                        <img src="https://rub-on.ru/frontend/web/img/mail/line.png" alt="" style="display:block;">
                                    </div>
                                </td>
                            </tr>
                            </tbody>
                        ...
                        <table width="600" align="center" border="0" cellpadding="0" cellspacing="0" data-editable="text">
                            ...
                            <tr>
                                <td align="right" valign="top" style="margin: 0px; padding: 15px 10px 0px 10px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); background-color: rgba(13, 14, 22, 0.8);">
                                    <img src="https://rub-on.ru/frontend/web/img/mail/podpis.png" alt="">
                                </td>
                            </tr>
                            </tbody>
                        </table>
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" align="left" width="150" data-editable="line" style="background-color: #fff; padding: 0px 28px;">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <?php else: ?>
                                                                        <img src="https://rub-on.ru/frontend/web//img/no-img.png" alt="" style="width:142px; height: 100px;">
                                                                    <?php endif; ?>
                                                                </td>
                                                            </tr>
                                                            <tr>
                            ...
                            <tr>
                                <td style="padding-left: 25px;">
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" data-editable="preheader" data-webinar="0">
                                        ...
                                        <tr><td><img src="https://rub-on.ru/frontend/web/img/mail/short_lineW.png" alt=""></td></tr>
                                ...
                                <td style="padding-left: 20px;">
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" data-editable="preheader" data-webinar="0">
                                        ...
                                        <tr>
                                            <td>
                                                <span><a href="https://vk.com/rub_on"><img src="https://rub-on.ru/frontend/web/img/mail/vk.png" alt=""></a></span>
                                                <span><a href="https://www.facebook.com/groups/rubonru/"><img src="https://rub-on.ru/frontend/web/img/mail/fb.png" alt=""></a></span>
                                                ...
                                                <span><a href="https://twitter.com/ru_bon_ru"><img src="https://rub-on.ru/frontend/web/img/mail/tw.png" alt=""></a></span>
                                                <span><a href="https://plus.google.com/117466825603530500753"><img src="https://rub-on.ru/frontend/web/img/mail/gg.png" alt=""></a></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <img src="https://rub-on.ru/frontend/web/img/mail/mail_logo.png" alt="" width="148px;">
                                            </td>
                                        </tr>
                                        <tr><td></td></tr>
                                        </tbody>
